        ...
        div(
          ...
          tabsetPanel(
            ...
            tabPanel("Pathway Enrichment",
                     fluidRow(
                       column(12, 
                              box(width = NULL, title = "Pathway Enrichment Analysis",
                                  tagList(
                                    list(
                                      tags$li("Select a dataset and column with identifier(InChI). Click 'Run Gather Identifiers' to collect chemical identifiers for enrichment analysis."),
                     ...
                     fluidRow(
                       column(6, 
                              box(width = NULL,
                                  ...
                                  selectInput("select_enrichment_data", "Select Dataset for Identifier gathering", choices = NULL, width = "100%"),
                                  # Dropdown for identifier column selection
                                  selectInput("identifier_column", "Select Identifier Column", choices = NULL, width = "100%"),
                                  # Action buttons for gathering identifiers and enrichment analysis
                       ...
                       column(6, 
                              box(width = NULL,
                                  # Add title for the number of identifiers gathered
                                  h4("Number of Identifiers Gathered"),
                                  # Add a text output for the number of identifiers gathered
                                  textOutput("identifier_count_text"),
                                  # Use uiOutput to render HTML content
                                  uiOutput("identifier_count_table")
                              )
                       ),
                       column(12, 
                              box(width = NULL,
                                  # Table output for enrichment results
                                  DTOutput("identifier_table")
                              )
                       ),
                       column(12, 
                              box(width = NULL,
                                  # Plot output for enrichment results
